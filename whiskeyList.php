...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <!-- <h2 class="text-center">whiskey</h2> -->
                    <div class="col-md-12">
                        <div class="row">
                            <?php

                            $query = "select * from whiskey WHERE stock='Yes' LIMIT 3";
                            ...
                            <div class="col-md-4">
                                ...
                                // Check if the product is out of stock
                                    ...
                                    ?>
                                    <form action="whiskey.php?id=<?= $row['id'] ?>" method="post">
                                        <?php
                                        $imageData = $row['image'];
                                        $imageSrc = 'data:image/png;base64,' . base64_encode($imageData);
                                        ?>
                                        <img src="displaywhiskey.php?id=<?php echo $row['id'];?>" style="height: 150px;" alt="<?= $row['name']; ?>">
                                        <h5><?= $row['name']; ?></h5>
